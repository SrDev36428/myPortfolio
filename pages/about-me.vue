      ...
      <div id="section-content" class="hidden lg:block w-full h-full border-right">
        ...
        <div id="contact-sources" class="hidden lg:flex lg:flex-col my-2">
          <div
            ...
            :key="key"
            class="flex items-center mb-2 relative group max-w-[250px] overflow-hidden text-ellipsis whitespace-nowrap"
          >
            ...
            <a
              :href="
                key === 'email'
                  ...
                  : '/'
              "
              class="font-fira_retina text-menu-text hover:text-white block group-hover:whitespace-normal group-hover:break-all"
            >
              {{ source }}
            </a>
          </div>
...
export default {
  ...
  methods: {
    ...
    focusCurrentFolder(folder) {
      ...
      this.currentSection = this.config.about.sections[this.currentSection].info[
        folder.title
      ]
        ? this.currentSection
